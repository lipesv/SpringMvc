...
<form:form method="POST" modelAttribute="account" id="accountForm">
	...
	<fieldset>
		<legend>
			<spring:message code="account.personal" />
		</legend>
		<table>
			<tr>
				<td><form:label path="firstName" cssErrorClass="error">
						<spring:message code="account.firstname" />
					</form:label></td>
			...
			<tr>
				<td><form:label path="lastName" cssErrorClass="error">
						<spring:message code="account.lastname" />
					</form:label></td>
				<td><form:input path="lastName" /></td>
				<td><form:errors path="lastName" /></td>
			</tr>
			<tr>
				<td><form:label path="dateOfBirth" cssErrorClass="error">
						<spring:message code="account.dob" />
					</form:label></td>
				<td><form:input path="dateOfBirth" type="date" /></td>
				<td><form:errors path="dateOfBirth" /></td>
			</tr>
			<tr>
				<td><form:label path="address.street" cssErrorClass="error">
			...
			<tr>
				<td><form:label path="address.houseNumber"
						cssErrorClass="error">
			...
			<tr>
				<td><form:label path="address.boxNumber" cssErrorClass="error">
						<spring:message code="address.boxNumber" />
					</form:label></td>
				<td><form:input path="address.boxNumber" /></td>
				<td><form:errors path="address.boxNumber" /></td>
			</tr>
			<tr>
				<td><form:label path="address.city" cssErrorClass="error">
			...
			<tr>
				<td><form:label path="address.postalCode" cssErrorClass="error">
			...
			<tr>
				<td><form:label path="address.country" cssErrorClass="error">
						<spring:message code="address.country" />
					</form:label></td>
				<td><form:select path="address.country" items="${countries}" /></td>
	...
	<fieldset>
		<legend>
			<spring:message code="account.userinfo" />
		</legend>
		<table>
			<tr>
			...
			<tr>
				<td><form:label path="emailAddress" cssErrorClass="error">
...
<form id="orderForm" action="<c:url value="/order/upload"/>"
...
<h1>
	<spring:message code="account.orders" />
</h1>
<table>
	<tr>
		<th>#</th>
	...
	<c:forEach items="${orders}" var="order">
		...
		<tr>
			...
			<td><a href="${htmUrl}" target="_blank">HTML</a>|<a
				href="${pdfUrl}" target="_blank">PDF</a>|<a href="${xlsUrl}"
